...
function Services(params) {
    return(
        <div className="w-full h-full">
            ...
            {/* Services 1 */}
            <div className="p-10 grid grid-cols-1 place-items-center lg:grid-cols-2 gap-5">
            ...
            {/* Services 2 */}
            <div className="p-10 grid grid-cols-1 place-items-center lg:grid-cols-2 gap-5">
                <div className="bg-gray-300 w-full h-full rounded-md p-5 text-slate-600 relative cardServices order-1 lg:order-2">
                ...
                <div className="w-full h-ful p-5 grid place-items-center order-2 lg:order-1">
